...
<head>
    ...
    <link href="assets/css/kegiatan.css" rel="stylesheet" type="text/css">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="kegiataninternal.php">Internal</a>
                            <a class="dropdown-item" href="kegiataneksternal.php">Eksternal</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#">Event</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container container-fluid">
            ...
            <div class="row justify-content-center">
                <div class="description-container d-flex justify-content-center">
                    <div>
                        <div>
                            <p>*Jenis Kegiatan (Seminar, dll)</p>
                            <p>01 Jan 2022</p>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p style="text-align:justify">
                                                ...
                                                (JPT) Eselon II Kepala Biro Akademik dan Umum Institut Seni Budaya
                                                Indonesia</p><br>
                                            <p style="font: size 12px;px">
                                                <br>Pukul : 10.00 WIB<br>Tanggal : 01 Januari 2022<br>Tempat : Gedung ...............
                                                </p><br>
                                            <p style="font-size:13px">
                                                <br>#ISBIBandung<br>#KampusMerdeka<br>#MerdekaBelajar<br>
                                                #CentreofCreativityBasedonArtManagementandNetworking</p>
